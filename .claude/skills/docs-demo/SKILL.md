---
name: docs-demo
description: Add an interactive demo to the Remotion documentation. Use when creating a new component for docs pages.
---
...
2. **Register the demo** in `packages/docs/components/demos/types.ts`:
   ...
   - `id`: unique string used in `<Demo id="my-demo" />`
...
4. **Use in MDX** with `<Demo id="my-demo" />`
